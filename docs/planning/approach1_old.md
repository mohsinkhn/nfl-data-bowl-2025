...
It seems there is 18 weeks worth of data. For validation split, lets keep last 4 weeks and use rest for training. for another validation fold, we can also keep weeks 9-12 as validation to see if temporality has any effect.